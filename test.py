...
#thingName = 'OBU'
topic = "1/obu/trigger/start"

if args.mode not in AllowedActions:
    parser.error("Unknown --mode option %s. Must be one of %s" % (args.mode, str(AllowedActions)))
    exit(2)

if not 'cert.pem' or not 'private.key':
...
while retryCount != 0:
    try:
        ...
        discovered = True
        print("Now proceed to the connectinfg flow...")
        break
...
if args.mode == 'both' or args.mode == 'subscribe':
    myAWSIoTMQTTClient.subscribe(tp, 0, None)
time.sleep(2)
